...
| **多边形标注** | 点击绘制、顶点编辑、插入/删除顶点、拖拽移动；**开放线自动膨胀**：沿裂纹画一条中心线，双击或 Enter 自动生成带状多边形；**区分光标**：顶点拖拽用十字，整体拖拽用四向箭头 |
| 多选 | Ctrl+点击多选，批量操作 |
...
4. **多边形标注**: 按 `P` 进入多边形模式，逐点击画多边形，双击或点击起点闭合。**裂纹标注**：沿裂缝画一条中心线（2+个点），双击或 Enter 自动膨胀为带状多边形
